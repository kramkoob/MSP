// Test program using a Maxim MAX7219 and an analog stick
// Position of the stick directly correlates to drawn pixel
// Active pixels are stored in memory
// Press button to erase instead of draw

// Thomas Dodds - 20 Nov 2020
